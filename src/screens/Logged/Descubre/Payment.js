                        ...
                        Promise.resolve(presentresult).then(async (e) => {
                            if (e.error) {
                                ...
                                if (cardInfo.fullName === "Personalizada") {
                                    await db.collection('goals').doc(insertKey).set({ ...cardInfo, created_at: new Date() });
                                } else if (cardInfo.fullName === "Psychology") {
                                    await db.collection('psychology').doc(insertKey).set({ ...cardInfo, created_at: new Date() });
                                } else {
