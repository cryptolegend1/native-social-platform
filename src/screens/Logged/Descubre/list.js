                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <Stack bg={COLOR.white} p={5} m={5} borderRadius={16}>
                        <TouchableOpacity onPress={() => NextPage(0, "Estudiar")}>
                            ...
                            <Button colorScheme="blue" onPress={() => NextPage(0)} bg="#00160A" px={7} alignSelf="center" borderRadius={100}>Estudiar</Button>
                        </TouchableOpacity>
                    </Stack>
                    <Stack bg={COLOR.white} p={5} m={5} borderRadius={16}>
                        <TouchableOpacity onPress={() => NextPage(1, "Hacer stream")}>
                            <Image source={Images.DescubreList2} resizeMode="contain" />
                            <Button colorScheme="blue" onPress={() => NextPage(1)} bg="#00160A" px={7} alignSelf="center" borderRadius={100}>Hacer stream</Button>
                        </TouchableOpacity>
                    </Stack>
                    <Stack bg={COLOR.white} p={5} m={5} borderRadius={16}>
                        <TouchableOpacity onPress={() => NextPage(2, "Crear diseño")}>
                            <Image source={Images.HomeImage2} resizeMode="contain" my={-10} />
                            <Button colorScheme="blue" onPress={() => NextPage(2)} bg="#00160A" px={7} alignSelf="center" borderRadius={100}>Crear diseño</Button>
                        </TouchableOpacity>
                    </Stack>
                </ScrollView>
            </Stack>
