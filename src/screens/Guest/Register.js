...
import { Box, Button, HStack, Icon, Input, Spinner, Stack, Text, useToast, View } from 'native-base';
        ...
        <View style={styles.container} pt={12}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.swiper} p={7} pt={5} >
                    ...
                    <Stack d={currentPage === 2 ? "flex" : "none"} py={5}>
                        ...
                        />
                        <Text fontSize="xs" my={3}>Confirm phone number with code from sms message</Text>
                        <Box>
                    ...
                    <Stack d={currentPage === 3 ? "flex" : "none"} py={5}>
                        <Text textAlign="center" fontSize="sm" mb={5}>{"Complete los datos de registro. Tardará un par\nde minutos. Todo lo que necesita es un\n    número de teléfono y un correo electrónico."}</Text>
                        <Stack p={3} bg="#EFF7FF" space={1}>
                            <Text color={COLOR.black}>{phoneNumber}</Text>
                            <HStack alignItems="center" >
                                <Icon size="sm" color={COLOR.base} as={<Ionicons name="checkmark-sharp" />} />
                                <Text fontSize="xs">Number confirmed</Text>
                            </HStack>
                        </Stack>

                        <Text fontSize="xs" mt={5}>Enter your email</Text>
                        <Input
                            error={true}
                        ...
                        />
                        <Text fontSize="xs" mt={5}>Enter your Name</Text>
                        <Input
                            error={true}
                        ...
                        <Button colorScheme="blue" bg="#007AFF" _text={{ color: "white" }} w={40} alignSelf="center" onPress={HandleSignUp} disabled={loading} my={5}>
                            {
                                loading ?
                                    <Spinner size="sm" /> :
                                    "Register now"
